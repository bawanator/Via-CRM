  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      <Dialog.Portal>
        ...
        >
          <header className="bar-blur sticky top-0 z-10 flex min-h-11 items-center justify-between gap-2 rounded-t-2xl border-b-[0.5px] border-separator px-4 py-1.5">
            <Dialog.Close asChild>
              <button className="text-body pressable control-h rounded-lg px-1 text-blue">Cancel</button>
            </Dialog.Close>
